/**
 * Canonical mock rows for standalone deploy (`services/pk-mock-category-apis`).
 * Keeps parity with `backend/tools/mock_pk_category_signals.py`; update both when scenarios change.
 */
